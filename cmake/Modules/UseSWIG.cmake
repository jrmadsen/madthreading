...
# Create Swig module
#
macro(SWIG_ADD_MODULE name language main_file)
  SWIG_MODULE_INITIALIZE(${name} ${language})
  set(swig_dot_i_sources ${main_file})
  if(${main_file} MATCHES "\\.i$")
      set(swig_other_sources)
  else()
      set(swig_other_sources ${main_file})
  endif()
  foreach(it ${ARGN})
    if(${it} MATCHES "\\.i$")
