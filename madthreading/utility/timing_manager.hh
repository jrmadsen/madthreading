...
#ifndef timing_manager_hh_
#define timing_manager_hh_
...
public:
    ...
    typedef mad::util::timer                  mad_timer_t;
    typedef mad_timer_t::string_t             string_t;
    typedef std::pair<string_t, mad_timer_t&> timer_pair_t;
    ...
    typedef uomap<string_t, mad_timer_t>      timer_map_t;
    typedef mad_timer_t::ostream_t            ostream_t;
    typedef mad_timer_t::ofstream_t           ofstream_t;
    typedef mad::clock_type                   clock_type;
...
public:
    ...
    mad_timer_t& timer(const string_t& key,
    ...
    mad_timer_t& at(size_type i) { return m_timer_list.at(i).second; }
    mad_timer_t& at(string_t key, const string_t& tag = "cxx");
...
{
    mad_timer_t& _t = this->instance()->timer(key);
    _t.start();
    _Ret _ret = func();
    _t.stop();
    return _ret;
...
//----------------------------------------------------------------------------//
inline timing_manager::mad_timer_t&
