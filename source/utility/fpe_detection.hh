...
static struct sigaction termaction, oldaction;
...
inline void DisableInvalidOperationDetection()
{
    ...
    termaction.sa_handler = SIG_DFL;
    sigaction(SIGFPE,  &termaction, 0);
    sigaction(SIGSEGV, &termaction, 0);
}
