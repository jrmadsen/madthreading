...
#ifndef base_clock_hh_
#define base_clock_hh_
...
ostream&
operator<<(ostream& os,
           const chrono::duration<mad::util::base_clock<_Precision>, _Period>& dur)
{
    auto rep = dur.count();
    return (os
            << "[user "
            ...
            << get<1>(rep.data) << ", real "
            << get<2>(rep.data) << ' '
            << mad::util::time_units<_Period>::repr
            << " ("
...
constexpr duration<mad::util::base_clock<_Pr>, _Per>
operator-(const time_point<mad::util::base_clock<_Pr>,
          duration<mad::util::base_clock<_Pr>, _Per>>& lhs,
          const time_point<mad::util::base_clock<_Pr>,
          duration<mad::util::base_clock<_Pr>, _Per>>& rhs)
{
    typedef duration<mad::util::base_clock<_Pr>, _Per> _duration;
    return _duration(mad::util::base_clock<_Pr>
    { make_tuple(
      // user time
...
constexpr duration<mad::util::base_clock<_Pr1>, _Pr1>
operator-(const time_point<mad::util::base_clock<_Pr1>,
          duration<mad::util::base_clock<_Pr1>, _Per1>>& lhs,
          const time_point<mad::util::base_clock<_Pr2>,
          duration<mad::util::base_clock<_Pr2>, _Per2>>& rhs)
{
    ...
    typedef duration<mad::util::base_clock<_Pr1>, _Per1> _duration;
    return _duration(mad::util::base_clock<_Pr1>
    { make_tuple(
      // user time
      get<0>(lhs.time_since_epoch().count().data)
      - get<0>(rhs.time_since_epoch().count().data),
