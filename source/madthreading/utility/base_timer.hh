...
#ifndef base_timer_hh_
#define base_timer_hh_

//----------------------------------------------------------------------------//

#include "madthreading/utility/base_clock.hh"
#include <fstream>
#include <string>
...
public:
    ...
    typedef mad::util::time_units<ratio_t>                time_units_t;
    typedef mad::util::base_clock<ratio_t>                base_clock_t;
