...
pybind11_add_module(threading MODULE ${DIR}/pythreading.cc)
target_link_libraries(threading PRIVATE ${PROJECT_LIBRARIES})

install(TARGETS threading DESTINATION ${CMAKE_INSTALL_PYTHONDIR}/madthreading)
